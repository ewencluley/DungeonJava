	...
	implements CaretListener, DocumentListener, PropertyChangeListener
{
	...
	private ArrayList<Integer> highlightedLines = new ArrayList<Integer>();
	...
	public void paintComponent(Graphics g)
	{
		...
		while (rowStartOffset <= endOffset)
		{
			try
            {
    			...
    			g.setFont(Font.decode("Arial-PLAIN"));
    			if(this.highlightedLines.contains(Integer.parseInt(lineNumber))){
...
//
	...
	public void unhighlightAllLines(){
		highlightedLines = new ArrayList<Integer>();
		this.repaint();
	}
